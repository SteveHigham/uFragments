...
contract('UFragmentsPolicy:initialize', function (accounts) {
...
contract('UFragmentsPolicy:setMarketOracle', function (accounts) {
  before('setup UFragmentsPolicy contract', setupContracts);
...
contract('UFragmentsPolicy:setCpiOracle', function (accounts) {
  before('setup UFragmentsPolicy contract', setupContracts);
...
contract('UFragmentsPolicy:setOrchestrator', function (accounts) {
  before('setup UFragmentsPolicy contract', setupContracts);
...
contract('UFragmentsPolicy:setDeviationThreshold', function (accounts) {
...
contract('UFragmentsPolicy:setRebaseLag', function (accounts) {
  let prevLag;
  before('setup UFragmentsPolicy contract', async function () {
    await setupContracts();
  ...
  describe('when rebaseLag is more than 0', function () {
  ...
  describe('when rebaseLag is 0', function () {
...
contract('UFragmentsPolicy:setRebaseTimingParameters', function (accounts) {
  before('setup UFragmentsPolicy contract', async function () {
    await setupContracts();
  });
...
contract('UFragmentsPolicy:Rebase:accessControl', function (accounts) {
...
contract('UFragmentsPolicy:Rebase', function (accounts) {
